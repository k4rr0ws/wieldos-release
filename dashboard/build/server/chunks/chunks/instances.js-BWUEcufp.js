...
var selectBase = `
	SELECT s.id, s.name, s.type, s.config_json AS configJson, s.credentials_json AS credentialsJson, s.status,
		...
		(CASE WHEN s.type = 'transformer' THEN (SELECT COUNT(*) FROM transformers) ELSE 0 END) AS transformerCount
...
export { getPrimaryInstance as a, getInstanceCredentials as b, getInstance as c, listInstanceOptions as d, deleteInstance as e, findOrCreateInstance as f, getProviderValues as g, createInstance as h, listInstances as l, markInstanceChecked as m, updateInstance as u };
//# sourceMappingURL=instances.js-BWUEcufp.js.map
