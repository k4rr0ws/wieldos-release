import { a1 as head, _ as ensure_array_like, T as derived, a7 as attr_class, a9 as escape_html, a3 as spread_props, a0 as attr } from '../../../chunks/server.js-BeDXxHyW.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		const SCHEDULE_TEMPLATES = [
			{
				...
				events: [
					...
					{
						title: "🎯 Positive Intention Setting",
						startTime: "06:15",
						endTime: "06:30",
						category: "personal"
					},
					{
						title: "📋 Goal Setting + Day Planning",
						startTime: "06:30",
						endTime: "07:00",
						category: "work"
					},
					{
						title: "✍️ DEEP WORK — Creating",
						startTime: "07:00",
						endTime: "09:30",
						category: "work"
					},
					...
					{
						title: "🍽️ Lunch + Recharge",
						startTime: "11:30",
						endTime: "12:30",
						category: "personal"
					},
					{
						title: "⚙️ Execution, Meetings, Admin",
						startTime: "12:30",
						endTime: "16:30",
						category: "work"
					},
			...
			},
			{
				...
				events: [
					...
					{
						title: "📋 Content Plan + Hooks",
						startTime: "06:30",
						endTime: "07:00",
						category: "work"
					},
					{
						title: "✍️ DEEP WORK — Writing + Drafts",
						startTime: "07:00",
						endTime: "09:30",
						category: "work"
					},
			...
			},
			{
				...
				events: [
					...
					{
						title: "📋 Build Plan + Priorities",
						startTime: "06:30",
						endTime: "07:00",
						category: "work"
					},
					{
						title: "⚙️ DEEP WORK — Building",
						startTime: "07:00",
						endTime: "09:30",
						category: "work"
					},
			...
			},
			{
				...
				events: [
					...
					{
						title: "🗺️ DEEP WORK — Strategic Planning",
						startTime: "07:00",
						endTime: "09:30",
						category: "work"
					},
					...
					{
						title: "⚙️ Project Reviews + Decisions",
						startTime: "12:30",
						endTime: "14:30",
						category: "work"
					},
		...
		let templateDate = localDateString();
		let editOpen = false;
		let editEvent = null;
							...
							children: ($$renderer) => {
								{
									function child($$renderer, { props }) {
										Button($$renderer, spread_props([
											...
											{
												children: ($$renderer) => {
													Calendar_days($$renderer, { class: "size-4" });
								...
								if (Dialog_content) {
									...
									Dialog_content($$renderer, {
										...
										children: ($$renderer) => {
													...
													children: ($$renderer) => {
														if (Dialog_title) {
															...
															Dialog_title($$renderer, {
																children: ($$renderer) => {
																	$$renderer.push(`<!---->Schedule template`);
																},
																$$slots: { default: true }
															});
															$$renderer.push("<!--]-->");
														...
														if (Dialog_description) {
															...
															Dialog_description($$renderer, {
																children: ($$renderer) => {
																	$$renderer.push(`<!---->Apply a pre-built day structure to a date.`);
																},
																$$slots: { default: true }
															});
															$$renderer.push("<!--]-->");
											...
											$$renderer.push(` <form method="POST" action="?/createBatch" class="grid gap-4"><div class="-mt-2 flex flex-wrap items-center gap-1.5"><span class="text-muted-foreground text-[11px]">Templates:</span> <!--[-->`);
											const each_array = ensure_array_like(SCHEDULE_TEMPLATES);
							...
							children: ($$renderer) => {
								...
								if (Card_content) {
									...
									Card_content($$renderer, {
										...
										children: ($$renderer) => {
											$$renderer.push(`<!--[-->`);
											const each_array_3 = ensure_array_like(group.events);
...
//# sourceMappingURL=_page.svelte.js-ib3mEtiI.js.map
