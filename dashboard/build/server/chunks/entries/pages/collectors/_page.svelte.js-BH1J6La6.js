import { a1 as head, a9 as escape_html, _ as ensure_array_like, a7 as attr_class, a3 as spread_props, a0 as attr, T as derived, a6 as stringify } from '../../../chunks/server.js-BeDXxHyW.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		const COLLECTOR_TEMPLATES = [
			{
				key: "contract_events",
				label: "🔗 Track Contract Events",
				name: "Contract Event Monitor",
				adapterType: "viem_contract_events",
				scheduleMode: "scheduled",
				everyHours: 1
			},
			{
				key: "x_search",
				label: "🐦 Monitor X Search",
				name: "X Search Monitor",
				adapterType: "xapi_search",
				scheduleMode: "scheduled",
				everyHours: 2
			},
			{
				key: "telegram_group",
				label: "✈️ Monitor Telegram Group",
				name: "Telegram Group Monitor",
				adapterType: "telegram_fetch_messages",
				scheduleMode: "scheduled",
				everyHours: 1
			}
		];
								...
								if (Dialog_content) {
									...
									Dialog_content($$renderer, {
										...
										children: ($$renderer) => {
											...
											$$renderer.push(` <form method="POST" action="?/create" class="grid gap-4"><div class="-mt-4 flex flex-wrap items-center gap-1.5"><!--[-->`);
											const each_array = ensure_array_like(COLLECTOR_TEMPLATES);
											...
											Native_select($$renderer, {
												...
												children: ($$renderer) => {
													$$renderer.push(`<!--[-->`);
													const each_array_1 = ensure_array_like(data.instances);
											...
											Native_select($$renderer, {
												...
												children: ($$renderer) => {
													if (otherDefs().length) {
														...
														const each_array_2 = ensure_array_like(matchingDefs());
														...
														const each_array_3 = ensure_array_like(otherDefs());
														...
														$$renderer.push("<!--[-1-->");
														$$renderer.push(`<!--[-->`);
														const each_array_4 = ensure_array_like(matchingDefs());
														for (let $$index_4 = 0, $$length = each_array_4.length; $$index_4 < $$length; $$index_4++) {
															let def = each_array_4[$$index_4];
															$$renderer.option({ value: def.type }, ($$renderer) => {
																$$renderer.push(`${escape_html(def.label)}`);
															});
														}
						...
						if (Dialog_content) {
							...
							Dialog_content($$renderer, {
								children: ($$renderer) => {
									...
									const each_array_6 = ensure_array_like(data.settings);
									for (let $$index_6 = 0, $$length = each_array_6.length; $$index_6 < $$length; $$index_6++) {
										let setting = each_array_6[$$index_6];
								...
								children: ($$renderer) => {
									...
									Native_select($$renderer, {
										...
										children: ($$renderer) => {
											...
											$$renderer.push(` <!--[-->`);
											const each_array_7 = ensure_array_like(data.agents);
											for (let $$index_7 = 0, $$length = each_array_7.length; $$index_7 < $$length; $$index_7++) {
												let agent = each_array_7[$$index_7];
												$$renderer.option({ value: agent.id }, ($$renderer) => {
													$$renderer.push(`${escape_html(agent.name)}`);
												});
											}
						...
						children: ($$renderer) => {
							...
							if (Table_body) {
								...
								Table_body($$renderer, {
									children: ($$renderer) => {
										$$renderer.push(`<!--[-->`);
										const each_array_8 = ensure_array_like(data.collectors);
										for (let $$index_8 = 0, $$length = each_array_8.length; $$index_8 < $$length; $$index_8++) {
											let collector = each_array_8[$$index_8];
											if (Table_row) {
												$$renderer.push("<!--[-->");
												Table_row($$renderer, {
													class: "group",
...
//# sourceMappingURL=_page.svelte.js-BH1J6La6.js.map
