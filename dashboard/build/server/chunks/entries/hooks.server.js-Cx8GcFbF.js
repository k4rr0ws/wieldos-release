...
import { d as db } from '../chunks/db.js-tGTv_Rod.js';
import { b as listAgents, l as listAgentTasks, d as listPlaybooks, m as markTaskDispatched, g as getAgent, k as listUnreflectedObservations, n as createMemory, o as markObservationsReflected } from '../chunks/agents.js-xaDulNxk.js';
import { g as getSetting } from '../chunks/settings.js-B6ViW1Gq.js';
import { f as findOrCreateInstance, u as updateInstance } from '../chunks/instances.js-BWUEcufp.js';
import { c as createCollector, a as gatherContext, l as listDueCollectors } from '../chunks/tools.js-BWnlcMH6.js';
import { l as logEvent } from '../chunks/log.js-DBWwQvzy.js';
import { h as hasAnthropicKey, d as dispatchAgent, c as callClaudeTool, A as AiError } from '../chunks/agent-runtime.js-Cwc7AnXs.js';
import { r as runCollector } from '../chunks/collector.js-Brk3K-z9.js';
import { i as isPinConfigured, a as isValidSession } from '../chunks/auth.js-DmprVbMF.js';
import { l as listDueTransformers, r as runTransformer } from '../chunks/transformer.js-Cc-jlxVl.js';
...
function isCrossSiteFormPost(request) {
	if (!CSRF_METHODS.has(request.method) || !isFormContentType(request)) return false;
...
async function handle({ event, resolve }) {
	if (isCrossSiteFormPost(event.request)) return new Response("Cross-site POST form submissions are forbidden", { status: 403 });
...
export { handle };
//# sourceMappingURL=hooks.server.js-Cx8GcFbF.js.map
