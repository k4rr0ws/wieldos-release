												...
												children: ($$renderer) => {
													...
													if (Card_content) {
														...
														Card_content($$renderer, {
															...
															children: ($$renderer) => {
																$$renderer.push(`<!--[-->`);
																const each_array = ensure_array_like(personaRows());
																for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
																	let row = each_array[$$index];
																	$$renderer.push(`<div><p class="text-muted-foreground text-xs font-medium tracking-wide uppercase">${escape_html(row.label)}</p> <p class="text-sm whitespace-pre-wrap">${escape_html(row.value)}</p></div>`);
																}
																$$renderer.push(`<!--]-->`);
															},
															$$slots: { default: true }
												...
												children: ($$renderer) => {
													...
													if (Card_content) {
														...
														Card_content($$renderer, {
															...
															children: ($$renderer) => {
																$$renderer.push(`<!--[-->`);
																const each_array_1 = ensure_array_like(backgroundRows());
														...
														Card_content($$renderer, {
															children: ($$renderer) => {
																if (group.items.length > 0) {
																	...
																	$$renderer.push("<!--[-1-->");
																	$$renderer.push(`<p class="text-muted-foreground text-sm">None listed.</p>`);
																}
																$$renderer.push(`<!--]-->`);
															},
															$$slots: { default: true }
							...
							Tabs_content($$renderer, {
								...
								children: ($$renderer) => {
									...
									if (data.memories.length === 0) {
										...
										const each_array_5 = ensure_array_like(data.memories);
										for (let $$index_5 = 0, $$length = each_array_5.length; $$index_5 < $$length; $$index_5++) {
											let memory = each_array_5[$$index_5];
											if (Card) {
												$$renderer.push("<!--[-->");
												Card($$renderer, {
													class: "group",
							...
							Tabs_content($$renderer, {
								...
								children: ($$renderer) => {
									...
									if (data.playbooks.length === 0) {
										...
										const each_array_6 = ensure_array_like(data.playbooks);
										for (let $$index_8 = 0, $$length = each_array_6.length; $$index_8 < $$length; $$index_8++) {
											let playbook = each_array_6[$$index_8];
											if (Card) {
												$$renderer.push("<!--[-->");
												Card($$renderer, {
													class: "group",
															...
															Card_content($$renderer, {
																...
																children: ($$renderer) => {
																	if (playbook.steps.length > 0) {
																		...
																		const each_array_7 = ensure_array_like(playbook.steps);
																	...
																	if (playbook.triggerTags.length > 0) {
																		$$renderer.push("<!--[0-->");
																		$$renderer.push(`<div class="flex flex-wrap gap-1.5"><!--[-->`);
																		const each_array_8 = ensure_array_like(playbook.triggerTags);
							...
							Tabs_content($$renderer, {
								...
								children: ($$renderer) => {
									if (data.tasks.length === 0) {
										...
										$$renderer.push("<!--[-1-->");
										$$renderer.push(`<div class="grid gap-3"><!--[-->`);
										const each_array_9 = ensure_array_like(data.tasks);
										for (let $$index_9 = 0, $$length = each_array_9.length; $$index_9 < $$length; $$index_9++) {
											let task = each_array_9[$$index_9];
											if (Card) {
												$$renderer.push("<!--[-->");
												Card($$renderer, {
													class: "group",
							...
							Tabs_content($$renderer, {
								...
								children: ($$renderer) => {
									if (data.observations.length === 0) {
										...
										$$renderer.push("<!--[-1-->");
										$$renderer.push(`<div class="grid gap-3"><!--[-->`);
										const each_array_10 = ensure_array_like(data.observations);
										for (let $$index_11 = 0, $$length = each_array_10.length; $$index_11 < $$length; $$index_11++) {
											let obs = each_array_10[$$index_11];
											if (Card) {
												$$renderer.push("<!--[-->");
												Card($$renderer, {
													children: ($$renderer) => {
														if (Card_content) {
															...
															Card_content($$renderer, {
																...
																children: ($$renderer) => {
																	...
																	$$renderer.push(`<!----> <!--[-->`);
																	const each_array_11 = ensure_array_like(obs.tags);
																	for (let $$index_10 = 0, $$length = each_array_11.length; $$index_10 < $$length; $$index_10++) {
																		let tag = each_array_11[$$index_10];
																		Badge($$renderer, {
																			variant: "outline",
																			children: ($$renderer) => {
																				$$renderer.push(`<!---->${escape_html(tag)}`);
							...
							Tabs_content($$renderer, {
								...
								children: ($$renderer) => {
									if (data.dispatches.length === 0) {
										...
										$$renderer.push("<!--[-1-->");
										$$renderer.push(`<div class="grid gap-3"><!--[-->`);
										const each_array_12 = ensure_array_like(data.dispatches);
										for (let $$index_13 = 0, $$length = each_array_12.length; $$index_13 < $$length; $$index_13++) {
											let run = each_array_12[$$index_13];
											if (Card) {
												$$renderer.push("<!--[-->");
												Card($$renderer, {
													children: ($$renderer) => {
															...
															Card_content($$renderer, {
																...
																children: ($$renderer) => {
																	...
																	if (run.staged.length) {
																		...
																		const each_array_13 = ensure_array_like(run.staged);
																		for (let i = 0, $$length = each_array_13.length; i < $$length; i++) {
																			let action = each_array_13[i];
							...
							Tabs_content($$renderer, {
								...
								children: ($$renderer) => {
									if (data.deliverables.length === 0) {
										...
										$$renderer.push("<!--[-1-->");
										$$renderer.push(`<div class="grid gap-3"><!--[-->`);
										const each_array_14 = ensure_array_like(data.deliverables);
										for (let $$index_14 = 0, $$length = each_array_14.length; $$index_14 < $$length; $$index_14++) {
											let item = each_array_14[$$index_14];
											if (Card) {
												$$renderer.push("<!--[-->");
												Card($$renderer, {
													children: ($$renderer) => {
							...
							Dialog_content($$renderer, {
								children: ($$renderer) => {
									...
									Native_select($$renderer, {
										...
										children: ($$renderer) => {
											$$renderer.push(`<!--[-->`);
											const each_array_15 = ensure_array_like(TASK_STATUSES);
											for (let $$index_15 = 0, $$length = each_array_15.length; $$index_15 < $$length; $$index_15++) {
												let s = each_array_15[$$index_15];
									...
									Native_select($$renderer, {
										...
										children: ($$renderer) => {
											$$renderer.push(`<!--[-->`);
											const each_array_16 = ensure_array_like(TASK_PRIORITIES);
							...
							Dialog_content($$renderer, {
								children: ($$renderer) => {
									...
									Native_select($$renderer, {
										...
										children: ($$renderer) => {
											$$renderer.push(`<!--[-->`);
											const each_array_17 = ensure_array_like(MEMORY_TYPES);
											for (let $$index_17 = 0, $$length = each_array_17.length; $$index_17 < $$length; $$index_17++) {
												let type = each_array_17[$$index_17];
												$$renderer.option({
													value: type,
													class: "capitalize"
												}, ($$renderer) => {
								...
								children: ($$renderer) => {
									...
									if (!proposedTasks) {
										...
										if (runTarget?.steps?.length) {
											...
											const each_array_18 = ensure_array_like(runTarget.steps);
											for (let i = 0, $$length = each_array_18.length; i < $$length; i++) {
												let step = each_array_18[i];
												$$renderer.push(`<li>${escape_html(step)}</li>`);
											}
										...
										const each_array_19 = ensure_array_like(proposedTasks);
										for (let i = 0, $$length = each_array_19.length; i < $$length; i++) {
											let task = each_array_19[i];
				...
				Dialog($$renderer, {
					...
					directory; keep low for quick tasks. Default 5, max 15.</p></div> `);
									if (data.grantedTools?.length) {
										...
										const each_array_20 = ensure_array_like(data.grantedTools);
										for (let $$index_20 = 0, $$length = each_array_20.length; $$index_20 < $$length; $$index_20++) {
											let tool = each_array_20[$$index_20];
											Badge($$renderer, {
												children: ($$renderer) => {
...
//# sourceMappingURL=_page.svelte.js-xytIsdLt.js.map
